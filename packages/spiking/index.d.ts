...
export declare function learnHebbianNative(kernel: Float32Array, tokens: Float32Array, positiveContext: Float32Array, negativeContexts: Float32Array, numNegatives: number, inputDim: number, outputDim: number, learningRate: number, marginPositive: number, marginNegative: number): void
